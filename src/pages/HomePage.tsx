        ...
        <div className="relative z-10 bottom-0 bg-gradient-to-r from-light-green to-primary-green py-16">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-white text-lg md:text-xl font-medium mb-8 leading-relaxed uppercase">
              Cody is a journey that connects the world to the cultural essence
              of Ben Tre.
              <br />
              through handcrafted coconut candy – the iconic sweet of Vietnam’s
              riverlands.
              <br />
              Here, tradition, craftsmanship, and local stories blend into a
              truly immersive
              <br />
              experience.
            </p>
