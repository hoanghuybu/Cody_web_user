...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    'brand.heroSubtitle':
      'From the beloved land of Ben Tre, we are crafting a story of tradition and sustainability.',
  ...
  vn: {
    ...
    'brand.heroSubtitle':
      'Từ mảnh đất Bến Tre thân thương, chúng tôi viết nên câu chuyện về hương vị truyền thống và tinh thần bền vững.',
