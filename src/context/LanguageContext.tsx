...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    'cart.receiverName': 'Receiver Name',
    'cart.receiverNamePlaceholder': 'Login to display name',
    'cart.receiverNameHelp': 'Name is taken from login account',
    'cart.phoneNumber': 'Phone Number',
    'cart.phoneNumberPlaceholder': 'Enter phone number',
    'cart.fullPhoneNumber': 'Full phone number',
    'cart.deliveryAddress': 'Delivery Address',
    'cart.houseNumber': 'House number, street name (max 50 characters)',
    'cart.selectProvince': '-- Select Province/City --',
    'cart.selectDistrict': '-- Select District --',
    'cart.selectWard': '-- Select Ward --',
    ...
    'orderDetail.error': 'An error occurred',
    'orderDetail.personalInfo': 'Personal Information',
    'orderDetail.customerName': 'Customer Name:',
    'orderDetail.deliveryAddress': 'Delivery Address:',
    'orderDetail.phoneNumber': 'Phone Number:',
    ...
    'orderDetail.confirmCancel': 'Confirm Cancellation',
    'orderDetail.confirmCancelMessage': 'Are you sure you want to cancel order',
    'orderDetail.cannotUndo': 'This action cannot be undone!',
    'orderDetail.totalValue': 'Total value:',
    'orderDetail.itemCount': 'Number of items:',
    'orderDetail.items': 'items',
    'orderDetail.goBack': 'Go Back',
    'orderDetail.confirmCancelBtn': 'Confirm Cancellation',
    'orderDetail.cancelSuccess': 'Order cancelled successfully',
    'orderDetail.cancelSuccessMsg': 'Your order has been cancelled.',
    'orderDetail.cancelFailed': 'Order cancellation failed',
    'orderDetail.cancelFailedMsg': 'Cannot cancel this order.',
    'orderDetail.errorOccurred': 'An error occurred',
    ...
    'blog.copied': 'Copied!',
    'blog.copiedMessage': 'Article link has been copied to clipboard.',
    ...
    'custom.homepage.title': 'ARE YOU CELEBRATING A SPECIAL EVENT?',
    'custom.homepage.subtitle': 'TELL US ABOUT YOUR IDEA\nAND WE WILL BAKE IT',
    ...
    'custom.stickerName': 'Sticker name',
    ...
    'custom.specialNote': 'Special note',
    'custom.notePlaceholder': 'Enter your special request...',
    'custom.total': 'Total:',
    'custom.orderNow': 'Order Now',
    'custom.sticker': 'Sticker',
    'custom.product': 'Product',
    'custom.intro.title': 'Introduction',
    'custom.why.title': 'Why choose customized',
    'custom.features.title': 'Key Features',
    'custom.reason.title': 'Why choose CODY?',
    'custom.gift': 'gift',
    'custom.gifts': 'gifts',
  ...
  vn: {
    ...
    'cart.receiverName': 'Tên người nhận',
    'cart.receiverNamePlaceholder': 'Đăng nhập để hiển thị tên',
    'cart.receiverNameHelp': 'Tên được lấy từ tài khoản đăng nhập',
    'cart.phoneNumber': 'Số điện thoại',
    'cart.phoneNumberPlaceholder': 'Nhập số điện thoại',
    'cart.fullPhoneNumber': 'Số điện thoại đầy đủ:',
    'cart.deliveryAddress': 'Địa chỉ giao hàng',
    'cart.houseNumber': 'Số nhà, tên đường (tối đa 50 ký tự)',
    'cart.selectProvince': '-- Chọn Tỉnh/Thành phố --',
    'cart.selectDistrict': '-- Chọn Quận/Huyện --',
    'cart.selectWard': '-- Chọn Phường/Xã --',
    ...
    'orderDetail.error': 'Có lỗi xảy ra',
    'orderDetail.personalInfo': 'Thông tin cá nhân',
    'orderDetail.customerName': 'Tên khách hàng:',
    'orderDetail.deliveryAddress': 'Địa chỉ giao hàng:',
    'orderDetail.phoneNumber': 'Số điện thoại:',
    'orderDetail.orderNote': 'Ghi chú đơn hàng',
    'orderDetail.products': 'Sản phẩm',
    'orderDetail.quantity': 'Số lượng:',
    'orderDetail.total': 'Tổng:',
    'orderDetail.grandTotal': 'Tổng cộng:',
    'orderDetail.backToList': 'Quay lại danh sách',
    'orderDetail.cancelOrder': 'Hủy đơn hàng',
    'orderDetail.cancelling': 'Đang hủy...',
    'orderDetail.confirmCancel': 'Xác nhận hủy đơn hàng',
    'orderDetail.confirmCancelMessage': 'Bạn có chắc chắn muốn hủy đơn hàng',
    'orderDetail.cannotUndo': 'Hành động này không thể hoàn tác!',
    'orderDetail.totalValue': 'Tổng giá trị:',
    'orderDetail.itemCount': 'Số sản phẩm:',
    'orderDetail.items': 'sản phẩm',
    'orderDetail.goBack': 'Quay lại',
    'orderDetail.confirmCancelBtn': 'Xác nhận hủy',
    'orderDetail.cancelSuccess': 'Hủy đơn hàng thành công',
    'orderDetail.cancelSuccessMsg': 'Đơn hàng của bạn đã được hủy.',
    'orderDetail.cancelFailed': 'Hủy đơn hàng thất bại',
    'orderDetail.cancelFailedMsg': 'Không thể hủy đơn hàng này.',
    'orderDetail.errorOccurred': 'Có lỗi xảy ra',
    ...
    'blog.notFound': 'Không tìm thấy bài viết',
    ...
    'blog.shareOn': 'Chia sẻ trên',
    'blog.copied': 'Đã sao chép!',
    'blog.copiedMessage': 'Link bài viết đã được sao chép vào clipboard.',
    'blog.relatedPosts': 'Bài viết liên quan',
    'blog.backToBlog': 'Quay lại Blog',
    'blog.shareArticle': 'Chia sẻ bài viết',
    // Contact
    ...
    'custom.stickerName': 'Tên sticker',
    ...
    'custom.specialNote': 'Ghi chú đặc biệt',
    'custom.notePlaceholder': 'Nhập yêu cầu đặc biệt của bạn...',
    'custom.total': 'Tổng cộng:',
    'custom.orderNow': 'Đặt hàng ngay',
    'custom.sticker': 'Sticker',
    'custom.product': 'Sản phẩm',
    'custom.intro.title': 'Lời mở đầu',
    'custom.why.title': 'Tại sao chọn',
    'custom.features.title': 'Tính năng nổi bật',
    'custom.reason.title': 'Tại sao chọn CODY?',
